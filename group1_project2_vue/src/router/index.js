...
export const constantRoutes = [
    ...
    },
    {
        ...
        children: [{
            path: 'dbsource',
            name: 'dbsource',
            component: () => import('@/views/dbsource/dbsource'),
            meta: { title: '数据库源管理', icon: 'nested' },
            hidden: false,
        }]
    },
    {
        ...
        children: [{
            path: 'sqlquery',
            name: 'sqlquery',
            component: () => import('@/views/sqlquery/sqlquery'),
    ...
    //       path: 'sqltest',
    //       name: 'sqltest',
    //       component: () => import('@/views/fortest/sqltest'),
    //       meta: { title: '测试使用', icon: 'form' },
    //       hidden: false,
    //     }]
    //   },
